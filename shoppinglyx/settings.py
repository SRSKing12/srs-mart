...
SECRET_KEY = 'rgz7)hlbv!pccplv7=8k4@oqgkk&sle2m$xuf(i^zcm47+7$!@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1", "https://srs-mart.herokuapp.com/"]
...
EMAIL_FROM_ADDRESS = 'srs.mart.12@gmail.com'
EMAIL_MAIL_SUBJECT = 'Verify your email'
EMAIL_MAIL_HTML = 'mail_body.html'
EMAIL_MAIL_PLAIN = 'mail_body.txt'
EMAIL_TOKEN_LIFE = 60 * 60
EMAIL_PAGE_TEMPLATE = 'confirm_template.html'
EMAIL_PAGE_DOMAIN = 'https://srs-mart.herokuapp.com/'
